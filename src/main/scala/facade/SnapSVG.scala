...
package importedjs {
  ...
  package mina {
    ...
    @JSName("mina")
    @js.native
    object MinaObj extends js.Object {
...
//      def animate(attrs: js.Dictionary[String | Double | Boolean | js.Any], duration: Double, easing: js.Function1[Double, Double] = ???, callback: js.Function0[Unit] = ???): Element = js.native
      def animate(attrs: js.Dynamic, duration: Double, easing: js.Function1[Double, Double] = ???, callback: js.Function0[Unit] = ???): Element = js.native
      ...
      def attr(params: js.Dynamic): Element = js.native
    ...
    @js.native
    trait Fragment extends Element {
      override def select(query: String): Element = js.native

      override def selectAll(query: String = ???): Set = js.native
    }
    ...
    trait Paper extends Element {
      ...
      def group(els: js.Any*): Element = js.native
    ...
    @JSName("Snap")
    @js.native
    object SnapObj extends js.Object {
